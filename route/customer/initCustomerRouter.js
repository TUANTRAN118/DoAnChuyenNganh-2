...
const lienheController = require('../../controller/customer/lenheController');
...
const initCustomerRouter = (app) => {
    ...
    route.get('/lienhe', lienheController.viewLienHe);
    route.get('/huongdan', lienheController.viewHDGD);
